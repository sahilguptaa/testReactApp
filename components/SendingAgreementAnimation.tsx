...
const SENDING_STEPS = [
  'Generating agreement from template...',
  'Dispatching to the selected supplier...'
];

export const SendingAgreementAnimation: React.FC<{ onComplete?: () => void }> = ({ onComplete }) => {
  ...
  return (
    <div>
      <p className="font-medium mb-3">Sending agreement...</p>
